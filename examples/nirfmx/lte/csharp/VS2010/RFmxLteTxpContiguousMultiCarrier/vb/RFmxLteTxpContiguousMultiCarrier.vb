...
Public Class RFmxLteTxpContiguousMultiCarrier
    ...
    Private componentCarrierBandwidth As Double() = New Double(1) {}
    Private componentCarrierFrequency As Double() = New Double(1) {}
    ...
    Private Sub InitializeVariables()
        ...
        componentCarrierBandwidth(0) = 20000000.0                                                       ' (Hz) 
        componentCarrierBandwidth(1) = 20000000.0                                                       ' (Hz) 
        componentCarrierFrequency(0) = -9900000.0                                                       ' (Hz) 
        componentCarrierFrequency(1) = 9900000.0                                                        ' (Hz) 
