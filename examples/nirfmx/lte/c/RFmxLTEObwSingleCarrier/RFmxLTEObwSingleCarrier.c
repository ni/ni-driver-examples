...
//10[A-B]. Fetch OBW Measurements and Traces.
...
int main (int argc, char *argv[])
{
    ...
    RFmxCheckWarn(RFmxLTE_Initialize(rfsaResourceName, "", &instrumentHandle, NULL));
    ...
    RFmxCheckWarn(RFmxLTE_OBWFetchMeasurement(instrumentHandle, "", timeout, 
                                                    &occupiedBandwidth, &absolutePower, &startFrequency, &stopFrequency));
