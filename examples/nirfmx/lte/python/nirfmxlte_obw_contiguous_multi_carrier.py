"""
RFmx LTE OBW Contiguous Multi-Carrier Example
...
def example(resource_name, option_string):
    """LTE OBW contiguous multi-carrier measurement example."""
...
def _main(argsv):
    ...
    parser = argparse.ArgumentParser(
        description="Pass arguments for LTE OBW Contiguous Multi-Carrier Example",
