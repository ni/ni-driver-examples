"""
RFmx LTE UL PVT Single Carrier Example
...
def example(resource_name, option_string):
    """LTE uplink PVT single carrier measurement example."""
...
def _main(argsv):
    ...
    parser = argparse.ArgumentParser(
        description="Pass arguments for LTE UL PVT Single Carrier Example",
