"""
RFmx LTE CHP Contiguous Multi-Carrier Example
...
def example(resource_name, option_string):
    """LTE CHP contiguous multi-carrier measurement example."""
    ...
    try:
        ...
        for i in range(len(absolute_power)):
            print(f"\nCarrier:  {i}")
...
def _main(argsv):
    ...
    parser = argparse.ArgumentParser(
        description="Pass arguments for LTE CHP Contiguous Multi-Carrier Example",
