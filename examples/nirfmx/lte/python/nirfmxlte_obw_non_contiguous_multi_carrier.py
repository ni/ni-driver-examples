"""
RFmx LTE OBW Non-Contiguous Multi-Carrier Example
...
def example(resource_name, option_string):
    """LTE OBW non-contiguous multi-carrier measurement example."""
    ...
    try:
        ...
        for i in range(number_of_subblocks):
            ...
            (
                ...
                stop_frequency,
                error_code,
            ) = lte_signal.obw.results.fetch_measurement(subblock_string, timeout)
            print("\n*****************************************")
            print(f"\nSubblock  : {i}")
...
def _main(argsv):
    ...
    parser = argparse.ArgumentParser(
        description="Pass arguments for LTE OBW Non-Contiguous Multi-Carrier Example",
