"""
RFmx LTE UL PVT Contiguous Multi-Carrier Example
...
def example(resource_name, option_string):
    """LTE UL PVT contiguous multi-carrier measurement example."""
    ...
    try:
        ...
        (
            ...
            burst_width,
            error_code,
        ) = lte_signal.pvt.results.fetch_measurement_array("", timeout)
        ...
        for i in range(number_of_component_carriers):
            print(f"\nCarrier  : {i}")
            print(f"Status                               : {measurement_status[i].name}")
            print(f"Mean Absolute OFF Power Before (dBm) : {mean_absolute_off_power_before[i]}")
            print(f"Mean Absolute OFF Power After (dBm)  : {mean_absolute_off_power_after[i]}")
            print(f"Mean Absolute ON Power (dBm)         : {mean_absolute_on_power[i]}")
...
def _main(argsv):
    ...
    parser = argparse.ArgumentParser(
        description="Pass arguments for LTE UL PVT Contiguous Multi-Carrier Example",
