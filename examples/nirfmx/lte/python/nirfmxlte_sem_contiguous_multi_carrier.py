"""
RFmx LTE SEM Contiguous Multi-Carrier Example
...
def example(resource_name, option_string):
    """LTE SEM contiguous multi-carrier measurement example."""
    ...
    component_carrier_maximum_output_power = [0.0, 0.0]  # dBm
...
def _main(argsv):
    ...
    parser = argparse.ArgumentParser(
        description="Pass arguments for LTE SEM Contiguous Multi-Carrier Example",
