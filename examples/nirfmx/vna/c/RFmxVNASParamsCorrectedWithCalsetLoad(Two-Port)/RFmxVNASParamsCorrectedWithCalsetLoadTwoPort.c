...
//11. Read Number of SParams and X-Axis Values (aggregated frequency list).
//12. Fetch S-Parameter X data. 
//13. Fetch S-Parameter Y data for each S-Parameter.
//14. Fetch S-Parameter Correction State.
...
Error:
   ...
   RFmxCheckWarn(RFmxVNA_SParamsExportToSnPFile(instrumentHandle, "", sParamsSnPFilePath));
   if (instrumentHandle)
   {
