...
Namespace NationalInstruments.Examples.RFmxWlanOfdmModAccWithEvmBasedAutoLevel
    Public Class RFmxWlanOfdmModAccWithEvmBasedAutoLevel
        ...
        Private Sub ConfigureWlan()
            ...
            wlan.OfdmModAcc.Configuration.AutoLevel("", timeout)
            wlan.Initiate("", "")
        End Sub
        ...
        Private Sub RetrieveResults()
            ...
            wlan.OfdmModAcc.Results.FetchIQImpairments("", timeout, relativeIQOriginOffsetMean, iqGainImbalanceMean, iqQuadratureErrorMean, absoluteIQOriginOffsetMean,
                iqTimingSkewMean)
