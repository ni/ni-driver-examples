...
Public Class RFmxWlanOfdmModAccMimoAnalysisOnly
    ...
    Private IQ As ComplexWaveform(Of ComplexSingle)()
    ...
    Private numberOfWaveforms As Integer
   ...
   End Sub
    ...
    Private Sub ConfigureWlan()
        ...
        NIRfsgPlayback.ReadWaveformsFromFileComplex(filePath, numberOfWaveforms, IQ)
    ...
    Private Sub PrintResults()
        ...
        Console.WriteLine(vbLf & "------------------Impairments & PPDU nfo------------------" & vbLf)
        For i As Integer = 0 To numberOfFrequencySegments - 1
            segmentString = RFmxWlanMX.BuildSegmentString("", i)
            Console.WriteLine("------------Measurements for {0}-------------" & vbLf, segmentString)
            ...
            For j As Integer = 0 To numberOfReceiveChains - 1
                chainString = RFmxWlanMX.BuildChainString(segmentString, j)
                Console.WriteLine(vbLf & "------------------IQ Impairments for {0}------------------", chainString)
