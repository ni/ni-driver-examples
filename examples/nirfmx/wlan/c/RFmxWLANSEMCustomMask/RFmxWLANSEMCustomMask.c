...
int main(int argc, char *argv[])
{
   ...
   int32 maskType = RFMXWLAN_VAL_SEM_MASK_TYPE_CUSTOM;

   float64 offsetStartFrequency[NUMBER_OF_OFFSETS] = {9e06, 11e06, 20e06};
   float64 offsetStopFrequency[NUMBER_OF_OFFSETS] = {11e06, 20e06, 40e06};
   int32 offsetSideband[NUMBER_OF_OFFSETS] = {RFMXWLAN_VAL_SEM_OFFSET_SIDEBAND_BOTH, RFMXWLAN_VAL_SEM_OFFSET_SIDEBAND_BOTH, RFMXWLAN_VAL_SEM_OFFSET_SIDEBAND_BOTH};
   float64 relativeLimitStart[NUMBER_OF_OFFSETS] = {0.0, -20.0, -28.0};  /*(dB) */
   float64 relativeLimitStop[NUMBER_OF_OFFSETS] = {-20.0, -28.0, -40.0}; /*(dB) */
   ...
   RFmxCheckWarn(RFmxWLAN_SEMCfgNumberOfOffsets(instrumentHandle, "", NUMBER_OF_OFFSETS));
   RFmxCheckWarn(RFmxWLAN_SEMCfgOffsetFrequencyArray(instrumentHandle, "", offsetStartFrequency, offsetStopFrequency, offsetSideband, NUMBER_OF_OFFSETS));
   RFmxCheckWarn(RFmxWLAN_SEMCfgOffsetRelativeLimitArray(instrumentHandle, "", relativeLimitStart, relativeLimitStop, NUMBER_OF_OFFSETS));
