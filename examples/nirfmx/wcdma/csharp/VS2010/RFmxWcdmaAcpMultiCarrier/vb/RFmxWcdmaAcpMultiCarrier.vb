...
Public Class RFmxWcdmaAcpMultiCarrier
    ...
    ' seconds 
    Private measurementInterval As Double = 0.01
    ' seconds 
    ...
    Private offsetPowerReferenceCarrier As RFmxWcdmaMXAcpOffsetPowerReferenceCarrier = RFmxWcdmaMXAcpOffsetPowerReferenceCarrier.Composite
    ...
    Private Sub RetrieveResults()
        wcdma.Acp.Results.FetchOffsetMeasurementArray("", timeout, lowerRelativePower, upperRelativePower, lowerAbsolutePower,
                                                      upperAbsolutePower)

        wcdma.Acp.Results.FetchCarrierMeasurementArray("", timeout, absolutePower, relativePower)

        wcdma.Acp.Results.FetchTotalCarrierPower("", timeout, totalCarrierPower)

        wcdma.Acp.Results.FetchSpectrum("", timeout, spectrum)
    End Sub

    Private Sub PrintResults()
        Console.WriteLine(vbLf & "Total Carrier Power  (dBm) : {0}", totalCarrierPower)
