...
Public Class RFmxSpecAnAcpArrayExample
   ...
   Private centerFrequency As Double, referenceLevel As Double, autoSetReferenceLevel As Double,
           externalAttenuation As Double, rbw As Double, frequency As Double,
           sweepTimeInterval As Double, bandwidth As Double, measurementInterval As Double, timeout As Double
   ...
   Private Sub InitializeVariables()
      ...
      measurementInterval = 0.01    ' seconds 
      autoLevel = True
      ...
      ' Offset Channels	
      offsetChannelInput.integrationBandwidth = 1000000.0 ' Hz 
      ...
      offsetChannelInput.frequencyOffset(0) = 1000000.0   ' Hz 
      offsetChannelInput.frequencyOffset(1) = 2000000.0   ' Hz 
   ...
   Private Sub ConfigureSpecAn()
      ...
      specAn.Acp.Configuration.ConfigureCarrierRrcFilter("", carrierChannelInput.rrcFilterEnabled,
   ...
   Private Sub RetrieveResults()
      ...
      specAn.Acp.Results.FetchOffsetMeasurementArray("", timeout, lowerRelativePower,
                                                     upperRelativePower, lowerAbsolutePower,
                                                     upperAbsolutePower)

      specAn.Acp.Results.FetchCarrierMeasurement("", timeout, absolutePower,
                                                 totalRelativePower, carrierFrequency,
