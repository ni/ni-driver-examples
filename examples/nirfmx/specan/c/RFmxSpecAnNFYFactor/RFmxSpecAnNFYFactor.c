...
int main(int argc, char *argv[])
{
   ...
   int32 noiseSourceType = RFMXSPECAN_VAL_NF_Y_FACTOR_NOISE_SOURCE_TYPE_EXTERNAL_NOISE_SOURCE;
   char *noiseSourceRFSGPort = "";
   ...
   float64* analyzerNoiseFigure = NULL;
   ...
   RFmxCheckWarn(RFmxSpecAn_NFSetYFactorNoiseSourceType(instrumentHandle, "", noiseSourceType));
   RFmxCheckWarn(RFmxSpecAn_NFSetYFactorNoiseSourceRFSignalGeneratorPort(instrumentHandle, "", noiseSourceRFSGPort));
