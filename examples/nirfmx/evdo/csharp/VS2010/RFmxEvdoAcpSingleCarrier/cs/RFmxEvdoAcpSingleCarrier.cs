...
namespace NationalInstruments.Examples.RFmxEvdoAcpSingleCarrier
{
    public class RFmxEvdoAcpSingleCarrier
    {
        ...
        double measurementInterval = 0.02667;        /* seconds */
        ...
        void RetrieveResults()
        {
            ...
            evdo.Acp.Results.FetchOffsetMeasurementArray("", timeout, ref lowerRelativePower,
                ref upperRelativePower, ref lowerAbsolutePower, ref upperAbsolutePower);

            evdo.Acp.Results.FetchCarrierMeasurement("", timeout, out absolutePower,
                out relativePower);
