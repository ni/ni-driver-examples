...
Partial Public Class MainForm
   ...
   Private channelNumber As Integer, allIqImpairmentsEnabled As Integer, awgnEnabled As Integer, whiteningEnabled As Integer, autoHeadroomEnabled As Integer, packetHeaderArqn As Integer,
      packetHeaderSeqn As Integer, bdAddressLap As Integer, bdAddressUap As Integer, bdAddressNap As Integer, HeaderLtAddress As Integer, headerFlow As Integer,
      headerSeqn As Integer, whiteningclock As Integer, outputPort As Integer, terminalConfiguration As Integer
...
#Region "UI Initial Value Config Section"
   ...
   Private Sub ConfigurePkthdrArqnComboBox()
      ...
      pktHdrArqnComboBox.SelectedIndex = niBTSGConstants.PacketHeaderArqnNak
   End Sub
...
#End Region
   ...
   Private Sub StartGeneration()
      ...
      btsgSession.SetPacketType(Nothing, niBTSGConstants.PacketTypePoll)
