...
Partial Public Class MainForm
   ...
   Private powerLevel As Double, carrierFrequency As Double, upConverterCenterFrequency As Double, upConverterCenterFrequencyOffset As Double, actualHeadroom As Double, externalAttenuation As Double,
      headroom As Double, iCommonModeOffset As Double, qCommonModeOffset As Double, iOffset As Double, qOffset As Double

   Private channelNumber As Integer, whiteningEnabled As Integer, autoHeadroomEnabled As Integer, packetHeaderArqn As Integer, packetHeaderSeqn As Integer, bdAddressLap As Integer,
      bdAddressUap As Integer, bdAddressNap As Integer, HeaderLtAddress As Integer, headerFlow As Integer, headerSeqn As Integer, whiteningclock As Integer,
      outputPort As Integer, terminalConfiguration As Integer
...
#End Region
   ...
   Private Sub StartGeneration()
      ...
      btsgSession.SetPacketType(Nothing, niBTSGConstants.PacketTypeId)
