...
namespace NationalInstruments.Examples.BTGenerateDVPacket
{
   public partial class MainForm : Form
   {
      ...
      int channelNumber, allIqImpairmentsEnabled, awgnEnabled, whiteningEnabled, autoHeadroomEnabled, packetHeaderArqn, packetHeaderSeqn, actualPayloadLength, dataType, bdAddressLap, bdAddressUap, payloadLengthMode, payloadLength, bdAddressNap, HeaderLtAddress, headerFlow, headerPayloadLlid, dataseed, headerSeqn, dataPNOrder, whiteningclock, outputPort, terminalConfiguration;
      int dvVoicePayloadDataType, dvVoicePayloadPnOrder, dvVoicePayloadDataPnSeed;
      string model;
      ...
      private void ConfigureNumericUpDown()
      {
         ...
         dvPaydatPnorderNumeric.Minimum = int.MinValue;
         dvPaydatPnorderNumeric.Maximum = int.MaxValue;
         dvPaydatPnorderNumeric.Increment = 1;
         dvPaydatPnorderNumeric.Value = 9;
         dvPaydatPnorderNumeric.DecimalPlaces = 0;

         dvPaydatSeedNumeric.Minimum = int.MinValue;
         dvPaydatSeedNumeric.Maximum = int.MaxValue;
      ...
      private void ConfigureDvPayhdrDatatypeComboBox()
      {
         var dvPayhdrDatatypeValueList = new List<DictionaryEntry>();
      ...
      void StopGeneration()
      {
         ...
         if (rfsgSession != null)
         {
            ...
            try
            {
               ...
               niBTSG.RFSGClearDatabase(rfsgSession.GetInstrumentHandle().DangerousGetHandle(), null, "idle");
            }
            catch
            {
      ...
      void StartGeneration()
      {
         ...
         btsgSession.SetPacketType(null, niBTSGConstants.PacketTypeDv);
         ...
         btsgSession.SetPayloadPNSeed(null, dataseed);

         //Set Voice Data
         btsgSession.SetDVVoicePayloadDataType(null, dvVoicePayloadDataType);
         btsgSession.SetDVVoicePayloadPNOrder(null, dvVoicePayloadPnOrder);
         btsgSession.SetDVVoicePayloadPNSeed(null, dvVoicePayloadDataPnSeed);
      ...
      private void generateButton_Click(object sender, System.EventArgs e)
      {
         try
         {
            ...
            dvVoicePayloadDataType = (int)dvPayhdrDatatypeComboBox.SelectedValue;
            ...
            dataseed = (int)paydatSeedNumeric.Value;
            dvVoicePayloadDataPnSeed = (int)dvPaydatSeedNumeric.Value;
            ...
            dvVoicePayloadPnOrder = (int)dvPaydatPnorderNumeric.Value;
