...
Partial Public Class MainForm
   ...
   Private channelNumber As Integer, allIqImpairmentsEnabled As Integer, awgnEnabled As Integer, autoHeadroomEnabled As Integer, payloadLengthMode As Integer, payloadLength As Integer,
    payloadType As Integer, dirtyTxEnabld As Integer, outputPort As Integer, terminalConfiguration As Integer
   ...
   Private dataRate As Integer, zadoffChuIndex As Integer, physicalChannelAddress As Integer, hdtPacketFormat As Integer
   Private hdtPhyInterval As Double
