...
Partial Public Class MainForm
   ...
   Private channelNumber As Integer, allIqImpairmentsEnabled As Integer, awgnEnabled As Integer, whiteningEnabled As Integer, autoHeadroomEnabled As Integer, packetHeaderArqn As Integer,
      ...
      payloadLength As Integer, bdAddressNap As Integer, packetType As Integer, HeaderLtAddress As Integer, headerFlow As Integer, headerPayloadLlid As Integer,
      seed As Integer, headerSeqn As Integer, dataPNOrder As Integer, whiteningclock As Integer, uniqPkts As Integer, idleSlots As Integer,
...
#Region "UI Initial Value Config Section"
   Private Sub ConfigureNumericUpDown()
      ...
      numOfIdleSlotsNumeric.Minimum = Integer.MinValue
      numOfIdleSlotsNumeric.Maximum = Integer.MaxValue
      numOfIdleSlotsNumeric.Increment = 1
      numOfIdleSlotsNumeric.Value = 1
      numOfIdleSlotsNumeric.DecimalPlaces = 0

      numOfUniqNumeric.Minimum = Integer.MinValue
      numOfUniqNumeric.Maximum = Integer.MaxValue
