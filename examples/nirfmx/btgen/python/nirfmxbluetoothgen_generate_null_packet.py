r"""Bluetooth Generate Null Packet Example.
...
10. Create and Download NULL Packet Waveform and IDLE Waveform to RFSG.
...
def example(resource_name, option_string):
    """Run Bluetooth Generate Null Packet Example."""
    ...
    try:
        ...
        # Create and Download NULL Packet Waveform
        btsg_session.set_packet_type("", nirfmxbluetoothgen.PacketType.NULL.value)
...
def _main(argsv):
    ...
    parser = argparse.ArgumentParser(
        description="Pass arguments for Bluetooth Generate Null Packet Example",
