//===================================================================
//
// Title:       Generate Poll packet.c
// Purpose:     Example to Generate Poll packet
//
// 
...
int32 initGlobalVaribales(void)
{
	...
	strcpy(waveformName, "POLL");

	sprintf(script, "%s", "script GeneratePollPkt\nrepeat forever\ngenerate POLL\ngenerate idle\nend repeat\nend script");
...
int32 createAndDownloadWaveform(void)
{
	...
	checkWarn(niBTSG_SetPacketType(gBTSession, NULL, NIBTSG_VAL_PACKET_TYPE_IDLE));
