...
//===================================================================
//
// Title:       Generate Null packet.c
// Purpose:     Example to Generate Null packet
//
// 
...
int32 autoHeadroomEnabled, AWGNEnabled, WEnabled, actualPaylen;
...
int32 initGlobalVaribales(void)
{
	...
	strcpy(waveformName, "NULL");

	sprintf(script, "%s", "script GenerateNULLPkt\nrepeat forever\ngenerate NULL\ngenerate idle\nend repeat\nend script");
