//===================================================================
//
// Title:       Load Configuration from File.c
...
int32 chnNumber, standard, frequencyBand, outPort;
	
float64 upConverterCenterFrequency, extIQCarFreq;
...
int32 initGlobalVaribales(void)
{
	...
	//File path to load the configuration
...
int32 configureToolkitSession(void)
{
	...
	checkWarn(niBTSG_LoadConfigurationFromFile(gBTSession, fileName, NIBTSG_VAL_TRUE));  
