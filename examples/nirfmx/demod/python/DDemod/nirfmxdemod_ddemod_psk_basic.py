...
def example(resource_name, option_string):
    ...
    try:
        ...
        # Retrieve results
        mean_frequency_offset, mean_rms_evm, max_peak_evm, mean_modulation_error_ratio, error_code = (
...
def _main(argsv):
    ...
    parser = argparse.ArgumentParser(
        description="Pass arguments for DDemod PSK Basic Example",
