...
int main(int argc, char *argv[])
{
	...
	RFmxCheckWarn(RFmxDemod_DDemodCfgModulationType(instrumentHandle, "", RFMXDEMOD_VAL_DDEMOD_MODULATION_TYPE_MSK,
		RFMXDEMOD_VAL_DDEMOD_M_4, differentialEnabled));
	...
	/* Retrieve results */
	RFmxCheckWarn(RFmxDemod_DDemodRead(instrumentHandle, "", timeout, &meanFrequencyOffset, &meanRMSEVM, &maxPeakEVM,
