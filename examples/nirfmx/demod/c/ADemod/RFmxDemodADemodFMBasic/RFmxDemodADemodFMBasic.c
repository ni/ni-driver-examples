...
int main(int argc, char *argv[])
{
	...
	/* Retrieve results */
	RFmxCheckWarn(RFmxDemod_ADemodReadFM(instrumentHandle, "", timeout, &meanDeviation, &meanCarrierFrequencyError));
