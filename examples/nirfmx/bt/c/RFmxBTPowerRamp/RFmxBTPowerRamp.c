...
int main(int argc, char* argv[])
{
 ...
 int highDataThroughputPacketFormat = RFMXBT_VAL_HIGH_DATA_THROUGHPUT_PACKET_FORMAT_FORMAT0;
 ...
 float64* fortydBRiseTimeMean = 0;                                            /*(seconds) */
 ...
 RFmxCheckWarn(RFmxBT_SetHighDataThroughputPacketFormat(instrumentHandle, "", highDataThroughputPacketFormat));
 ...
 RFmxCheckWarn(RFmxBT_PowerRampGetResults40dBRiseTimeMean(instrumentHandle, "", &fortydBRiseTimeMean));
 ...
 printf("40dB Rise Time Mean (s)              : %lf\n\n", fortydBRiseTimeMean);
