...
' Description  : Use this example to learn how to use a Multicard Device(here NI2815) as a Single 
'Matrix device. The example marks the row channels as reserved for routing, and connects and disconnects the two channels specified.
'==================================================================================================
...
#Region "FormEvents"
    ...
    Private Sub connectButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles connectButton.Click
        Dim rowChannels As String() = {"card1r0", "card1r1", "card1r2", "card1r3"}
        ...
        Try
            ...
            For Each rowChannel As String In rowChannels
