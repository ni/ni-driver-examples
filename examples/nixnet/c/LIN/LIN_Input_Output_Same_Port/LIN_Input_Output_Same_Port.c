/*
// This example reads and writes signals on the same port.
...
int main(void)
{
   ...
   char *l_pSelectedOutputSignalList = "MasterSignal3_U8,MasterSignal4_U8";
   ...
   l_Status = nxCreateSession(l_pSelectedDatabase, l_pSelectedCluster,
      l_pSelectedInputSignalList, l_pSelectedInterface,
   ...
   // Both sessions use the same interface which is set to master mode.
   l_Status = nxCreateSession(l_pSelectedDatabase, l_pSelectedCluster,
      l_pSelectedOutputSignalList, l_pSelectedInterface,
   ...
   printf("Sessions Created Successfully.\n");

   printf("To start the interface, press 't' to transmit and 'r' to receive."
      " Press 'q' to quit.\n");
