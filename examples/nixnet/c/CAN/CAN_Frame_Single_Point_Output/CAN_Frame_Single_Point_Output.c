...
// manual. This example uses hardcoded frame names that use the NIXNET_example
...
int main(void)
{
   ...
   printf("Press any key to write the frame data or q to quit\n");
   printf("Since we are using event frames, the frames will be transmitted immediately.\n\n");
