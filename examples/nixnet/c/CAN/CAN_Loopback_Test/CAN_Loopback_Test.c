/*
// This example can be used to test CAN communication between two ports.
...
int main(void)
{
   ...
   char *l_pSelectedInterface2 = "CAN2";
   ...
   printf("Press any key to transmit or q to quit\n\n");
   ...
   {
      // Write out values incrementing by 1 everytime
