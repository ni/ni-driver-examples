/*
// This example demonstrates how to receive signals with a J1939 Signal Single Point Input
// session. It reads the J1939 signals when a keyboard character is pressed except 'q'.
// This example is designed to be run with J1939 Signal Single Point Output example, ensure
...
int main(void)
{
   ...
   // J1939 variables
   u64 l_NodeName = 5;       // J1939 Node Name
   u32 l_InAddress = 5;      // Proposed Address
   ...
   printf("Press any key to read the latest J1939 signal values or q to quit\n");

   // Main loop
   while ('q' != tolower(_getch()))
   {
      // Read the latest signal data
