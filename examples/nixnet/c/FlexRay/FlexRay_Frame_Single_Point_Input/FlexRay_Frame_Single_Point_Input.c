/*
// This example reads the latest frame value when a keyboard character is pressed.
...
int main(void)
{
   ...
   printf("Press any key to start the session and read"
      " the latest frame data. (q to quit)\n");
