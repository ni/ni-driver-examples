#
# makefile for the project MultiDeviceDynamicAcqAndGen-SourceSyncTClk
#
# To run this from command prompt type:
#    nmake /f MultiDeviceDynamicAcqAndGen-SourceSyncTClk.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=MultiDeviceDynamicAcqAndGen-SourceSyncTClk
!IF "$(CFG)" == ""
CFG=debug
