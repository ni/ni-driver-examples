#
# makefile for the project MultiDeviceDynamicGenerationTClkOptimizedforReconfig
#
# To run this from command prompt type:
#    nmake /f MultiDeviceDynamicGenerationTClkOptimizedforReconfig.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=MultiDeviceDynamicGenerationTClkOptimizedforReconfig
!IF "$(CFG)" == ""
CFG=debug
