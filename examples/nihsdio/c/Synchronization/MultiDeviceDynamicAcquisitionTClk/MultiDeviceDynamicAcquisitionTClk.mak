#
# makefile for the project MultiDeviceDynamicAcquisitionTClk
#
# To run this from command prompt type:
#    nmake /f MultiDeviceDynamicAcquisitionTClk.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=MultiDeviceDynamicAcquisitionTClk
!IF "$(CFG)" == ""
CFG=debug
