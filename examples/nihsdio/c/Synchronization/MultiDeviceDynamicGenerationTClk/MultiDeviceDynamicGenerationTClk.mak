#
# makefile for the project MultiDeviceDynamicGenerationTClk
#
# To run this from command prompt type:
#    nmake /f MultiDeviceDynamicGenerationTClk.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=MultiDeviceDynamicGenerationTClk
!IF "$(CFG)" == ""
CFG=debug
