#
# makefile for the project DynamicGenerationSoftwareScriptTrigger
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationSoftwareScriptTrigger.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationSoftwareScriptTrigger
!IF "$(CFG)" == ""
CFG=debug
