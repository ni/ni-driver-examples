#
# makefile for the project DynamicGenerationOfMultipleScripts
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationOfMultipleScripts.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationOfMultipleScripts
!IF "$(CFG)" == ""
CFG=debug
