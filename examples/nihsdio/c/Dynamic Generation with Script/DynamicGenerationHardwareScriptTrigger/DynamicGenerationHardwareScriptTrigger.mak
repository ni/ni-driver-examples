#
# makefile for the project DynamicGenerationHardwareScriptTrigger
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationHardwareScriptTrigger.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationHardwareScriptTrigger
!IF "$(CFG)" == ""
CFG=debug
