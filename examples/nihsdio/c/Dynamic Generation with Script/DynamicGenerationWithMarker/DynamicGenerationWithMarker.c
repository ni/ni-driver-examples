...
*
*  Example Program:
*    DynamicGenerationWithMarker.c
*
*  Description:
*    Generates a waveform based on specified script and exports a
*    marker event.
*
...
int main(void)
{
   ...
   ViConstString markerDestination = NIHSDIO_VAL_PFI0_STR;
   ViInt32 dataWidth = 4;
   ...
   /* Note: waveform names are referenced in script. Marker locations:
    * sample 0, sample 128. */
   ...
   checkErr(niHSDIO_ExportSignal(
            vi, NIHSDIO_VAL_MARKER_EVENT, "Marker0", markerDestination));
