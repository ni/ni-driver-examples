#
# makefile for the project DynamicAcquisitionHardwareStartTrigger
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionHardwareStartTrigger.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionHardwareStartTrigger
!IF "$(CFG)" == ""
CFG=debug
