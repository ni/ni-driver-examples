...
*
*  Example Program:
*    DynamicAcquisitionWithVoltageConfiguration.c
*
*  Description:
*    Acquires a simple pattern on specified channels using read
*    function and allows the user to change the acquisition
*    voltage levels
*
...
int main(void)
{
   ...
   /* Configure the acquisition voltage levels */
   checkErr(niHSDIO_ConfigureDataVoltageLogicFamily(
            vi, VI_NULL, NIHSDIO_VAL_3_3V_LOGIC));
