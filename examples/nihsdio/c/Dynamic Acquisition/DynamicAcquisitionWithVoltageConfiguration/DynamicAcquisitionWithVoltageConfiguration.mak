#
# makefile for the project DynamicAcquisitionWithVoltageConfiguration
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionWithVoltageConfiguration.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionWithVoltageConfiguration
!IF "$(CFG)" == ""
CFG=debug
