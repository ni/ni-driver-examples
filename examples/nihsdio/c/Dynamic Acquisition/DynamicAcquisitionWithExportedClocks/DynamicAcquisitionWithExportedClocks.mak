#
# makefile for the project DynamicAcquisitionWithExportedClocks
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionWithExportedClocks.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionWithExportedClocks
!IF "$(CFG)" == ""
CFG=debug
