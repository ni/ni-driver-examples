#
# makefile for the project DynamicAcquisitionOfMultipleRecords
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionOfMultipleRecords.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionOfMultipleRecords
!IF "$(CFG)" == ""
CFG=debug
