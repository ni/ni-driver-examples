#
# makefile for the project DynamicAcquisitionWithDataWidth
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionWithDataWidth.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionWithDataWidth
!IF "$(CFG)" == ""
CFG=debug
