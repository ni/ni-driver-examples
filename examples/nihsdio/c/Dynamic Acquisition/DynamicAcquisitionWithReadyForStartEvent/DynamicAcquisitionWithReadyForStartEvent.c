...
*
*  Example Program:
*    DynamicAcquisitionWithReadyForStartEvent.c
*
*  Description:
*    Exports the ready for start event in an acquisition operation.
*
...
int main(void)
{
   ...
   ViConstString eventTerminal = NIHSDIO_VAL_PFI0_STR;
   ViInt32 readTimeout = 10000;
   ...
   /* Configure ready for start event for export */
   checkErr(niHSDIO_ExportSignal(
            vi, NIHSDIO_VAL_READY_FOR_START_EVENT, VI_NULL, eventTerminal));
