#
# makefile for the project DynamicAcquisitionWithReadyForStartEvent
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionWithReadyForStartEvent.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionWithReadyForStartEvent
!IF "$(CFG)" == ""
CFG=debug
