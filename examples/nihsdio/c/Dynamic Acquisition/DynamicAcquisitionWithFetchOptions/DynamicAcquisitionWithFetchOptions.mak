#
# makefile for the project DynamicAcquisitionWithFetchOptions
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionWithFetchOptions.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionWithFetchOptions
!IF "$(CFG)" == ""
CFG=debug
