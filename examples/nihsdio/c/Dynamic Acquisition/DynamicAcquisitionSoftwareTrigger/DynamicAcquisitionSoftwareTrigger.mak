#
# makefile for the project DynamicAcquisitionSoftwareTrigger
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionSoftwareTrigger.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionSoftwareTrigger
!IF "$(CFG)" == ""
CFG=debug
