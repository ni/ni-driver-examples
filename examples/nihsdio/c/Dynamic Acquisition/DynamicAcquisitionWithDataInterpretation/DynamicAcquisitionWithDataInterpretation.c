...
*
*  Example Program:
*    DynamicAcquisitionWithDataInterpretation.c
*
*  Description:
*    Configures the data interpretation mode (high-low; valid-invalid)
...
int main(void)
{
   ...
   ViReal64 lowVoltageThreshold = 0.5;
   ViReal64 highVoltageThreshold = 3.3;
   ViReal64 sampleClockRate = 50.0e6;
   ViInt32 dataInterpMode = NIHSDIO_VAL_HIGH_OR_LOW;
   ...
   /* Configure acquisition voltage levels */
   checkErr(niHSDIO_ConfigureDataVoltageCustomLevels(
            vi, VI_NULL,
            lowVoltageThreshold,
   ...
   checkErr(niHSDIO_ConfigureDataInterpretation(
            vi, channelList, dataInterpMode));
