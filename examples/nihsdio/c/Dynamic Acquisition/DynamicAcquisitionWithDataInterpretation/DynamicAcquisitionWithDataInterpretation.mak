#
# makefile for the project DynamicAcquisitionWithDataInterpretation
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionWithDataInterpretation.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionWithDataInterpretation
!IF "$(CFG)" == ""
CFG=debug
