#
# makefile for the project DynamicAcquisitionWithReferenceClockPXI
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionWithReferenceClockPXI.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionWithReferenceClockPXI
!IF "$(CFG)" == ""
CFG=debug
