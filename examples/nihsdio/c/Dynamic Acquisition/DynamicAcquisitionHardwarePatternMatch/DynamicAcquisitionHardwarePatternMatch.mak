#
# makefile for the project DynamicAcquisitionHardwarePatternMatch
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionHardwarePatternMatch.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionHardwarePatternMatch
!IF "$(CFG)" == ""
CFG=debug
