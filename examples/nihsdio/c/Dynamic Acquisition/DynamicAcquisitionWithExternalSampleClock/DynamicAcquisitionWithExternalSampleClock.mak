#
# makefile for the project DynamicAcquisitionWithExternalSampleClock
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionWithExternalSampleClock.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionWithExternalSampleClock
!IF "$(CFG)" == ""
CFG=debug
