#
# makefile for the project DynamicAcquisitionWithDataDelay
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionWithDataDelay.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionWithDataDelay
!IF "$(CFG)" == ""
CFG=debug
