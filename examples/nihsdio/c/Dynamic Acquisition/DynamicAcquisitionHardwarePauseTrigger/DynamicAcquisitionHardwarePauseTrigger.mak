#
# makefile for the project DynamicAcquisitionHardwarePauseTrigger
#
# To run this from command prompt type:
#    nmake /f DynamicAcquisitionHardwarePauseTrigger.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcquisitionHardwarePauseTrigger
!IF "$(CFG)" == ""
CFG=debug
