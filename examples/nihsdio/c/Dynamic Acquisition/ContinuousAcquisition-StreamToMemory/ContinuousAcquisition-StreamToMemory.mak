#
# makefile for the project ContinuousAcquisition-StreamToMemory
#
# To run this from command prompt type:
#    nmake /f ContinuousAcquisition-StreamToMemory.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=ContinuousAcquisition-StreamToMemory
!IF "$(CFG)" == ""
CFG=debug
