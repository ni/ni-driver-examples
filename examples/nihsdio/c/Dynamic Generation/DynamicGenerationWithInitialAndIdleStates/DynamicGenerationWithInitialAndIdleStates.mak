#
# makefile for the project DynamicGenerationWithInitialAndIdleStates
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithInitialAndIdleStates.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithInitialAndIdleStates
!IF "$(CFG)" == ""
CFG=debug
