#
# makefile for the project DynamicGenerationWithReferenceClockPCI
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithReferenceClockPCI.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithReferenceClockPCI
!IF "$(CFG)" == ""
CFG=debug
