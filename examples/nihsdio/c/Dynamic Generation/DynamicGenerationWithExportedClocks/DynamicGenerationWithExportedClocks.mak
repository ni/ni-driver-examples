#
# makefile for the project DynamicGenerationWithExportedClocks
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithExportedClocks.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithExportedClocks
!IF "$(CFG)" == ""
CFG=debug
