#
# makefile for the project DynamicGenerationHardwareStartTrigger
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationHardwareStartTrigger.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationHardwareStartTrigger
!IF "$(CFG)" == ""
CFG=debug
