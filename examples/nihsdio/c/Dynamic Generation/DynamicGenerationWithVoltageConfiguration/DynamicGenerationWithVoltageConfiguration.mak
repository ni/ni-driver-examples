#
# makefile for the project DynamicGenerationWithVoltageConfiguration
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithVoltageConfiguration.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithVoltageConfiguration
!IF "$(CFG)" == ""
CFG=debug
