...
*
*  Example Program:
*    DynamicGenerationWithVoltageConfiguration.c
*
*  Description:
*    Generates a simple pattern on specified channels and allows
*    the user to change the generation voltage settings.
*
...
int main(void)
{
   ...
   ViInt32 logicFamily = NIHSDIO_VAL_3_3V_LOGIC;
   ...
   /* Specify the generation voltage logic family */
   checkErr(niHSDIO_ConfigureDataVoltageLogicFamily(
            vi, VI_NULL, logicFamily));
