#
# makefile for the project DynamicGenerationWithReferenceClockPXI
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithReferenceClockPXI.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithReferenceClockPXI
!IF "$(CFG)" == ""
CFG=debug
