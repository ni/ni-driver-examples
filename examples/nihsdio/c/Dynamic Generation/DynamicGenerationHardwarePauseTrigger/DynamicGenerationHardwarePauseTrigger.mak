#
# makefile for the project DynamicGenerationHardwarePauseTrigger
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationHardwarePauseTrigger.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationHardwarePauseTrigger
!IF "$(CFG)" == ""
CFG=debug
