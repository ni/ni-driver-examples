#
# makefile for the project DynamicGenerationWithOpenCollector
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithOpenCollector.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithOpenCollector
!IF "$(CFG)" == ""
CFG=debug
