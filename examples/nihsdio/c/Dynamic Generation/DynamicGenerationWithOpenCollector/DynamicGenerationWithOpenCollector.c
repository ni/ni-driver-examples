...
*
*  Example Program:
*    DynamicGenerationWithOpenCollector.c
*
*  Description:
*    Generates a simple pattern on specified channels with Open Collector
*    outputs by setting the Drive Type attribute.  Open Collector outputs
*    drive a low voltage for logic 0, and drive Tristate for a logic 1.
*
...
int main(void)
{
   ...
   /* Configure the Drive Type */
   checkErr(niHSDIO_SetAttributeViInt32(
            vi, VI_NULL, NIHSDIO_ATTR_DRIVE_TYPE, NIHSDIO_VAL_OPEN_COLLECTOR));
