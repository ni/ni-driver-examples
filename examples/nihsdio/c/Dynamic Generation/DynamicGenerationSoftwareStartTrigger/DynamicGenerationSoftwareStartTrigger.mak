#
# makefile for the project DynamicGenerationSoftwareStartTrigger
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationSoftwareStartTrigger.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationSoftwareStartTrigger
!IF "$(CFG)" == ""
CFG=debug
