...
*
*  Example Program:
*    DynamicGenerationSoftwareStartTrigger.c
*
*  Description:
*    Configures a software trigger to start pattern generation.
*
...
int main(void)
{
   ...
   checkErr(niHSDIO_ConfigureSoftwareStartTrigger(vi));
   ...
   /* Send software trigger to start generation */
   printf("Generation initiated.  Waiting on software start trigger. \n");
   printf("Hit <Enter> to send software start trigger...\n");
   getchar();

   checkErr(niHSDIO_SendSoftwareEdgeTrigger(
            vi, NIHSDIO_VAL_START_TRIGGER, VI_NULL));
