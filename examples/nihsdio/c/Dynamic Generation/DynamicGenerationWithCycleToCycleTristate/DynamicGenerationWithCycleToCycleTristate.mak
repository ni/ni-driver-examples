#
# makefile for the project DynamicGenerationWithCycleToCycleTristate
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithCycleToCycleTristate.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithCycleToCycleTristate
!IF "$(CFG)" == ""
CFG=debug
