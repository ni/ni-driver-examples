#
# makefile for the project DynamicGenerationOfMultipleWaveforms
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationOfMultipleWaveforms.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationOfMultipleWaveforms
!IF "$(CFG)" == ""
CFG=debug
