#
# makefile for the project DynamicGenerationWithRepeatMode
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithRepeatMode.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithRepeatMode
!IF "$(CFG)" == ""
CFG=debug
