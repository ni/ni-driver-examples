#
# makefile for the project ContinuousGeneration-StreamFromMemory
#
# To run this from command prompt type:
#    nmake /f ContinuousGeneration-StreamFromMemory.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=ContinuousGeneration-StreamFromMemory
!IF "$(CFG)" == ""
CFG=debug
