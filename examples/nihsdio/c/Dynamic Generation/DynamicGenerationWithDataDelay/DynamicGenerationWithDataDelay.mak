#
# makefile for the project DynamicGenerationWithDataDelay
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithDataDelay.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithDataDelay
!IF "$(CFG)" == ""
CFG=debug
