#
# makefile for the project DynamicGenerationWithDataActiveEvent
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithDataActiveEvent.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithDataActiveEvent
!IF "$(CFG)" == ""
CFG=debug
