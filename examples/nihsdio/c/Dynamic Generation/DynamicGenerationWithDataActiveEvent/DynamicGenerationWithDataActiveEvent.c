...
*
*  Example Program:
*    DynamicGenerationWithDataActiveEvent.c
*
*  Description:
*    Generates a waveform and exports the data active event.
*
...
int main(void)
{
   ...
   ViConstString eventDestination = NIHSDIO_VAL_PFI0_STR;
   ViInt32 dataWidth = 4;
   ...
   checkErr(niHSDIO_ExportSignal(
            vi, NIHSDIO_VAL_DATA_ACTIVE_EVENT,
            VI_NULL, eventDestination));
