#
# makefile for the project DynamicGenerationWithExternalSampleClock
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationWithExternalSampleClock.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationWithExternalSampleClock
!IF "$(CFG)" == ""
CFG=debug
