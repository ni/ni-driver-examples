#
# makefile for the project DynamicGenerationHardwareStopTrigger
#
# To run this from command prompt type:
#    nmake /f DynamicGenerationHardwareStopTrigger.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenerationHardwareStopTrigger
!IF "$(CFG)" == ""
CFG=debug
