...
*
*  Example Program:
*    DynamicGenerationHardwareStopTrigger.c
*
*  Description:
*    Demonstrates how to configure and stop the generation repeat mode
*    (continuous vs. finite -with repeat count- )
*
...
int main(void)
{
   ...
   ViInt32 repeatMode = NIHSDIO_VAL_CONTINUOUS;
   ViInt32 repeatCount = 0;
   ViConstString triggerTerminal = NIHSDIO_VAL_PXI_TRIG0_STR;
