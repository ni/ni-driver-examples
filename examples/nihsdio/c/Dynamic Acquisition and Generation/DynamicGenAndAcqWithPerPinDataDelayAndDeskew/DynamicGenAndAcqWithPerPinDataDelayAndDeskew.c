...
*
*  Example Program:
*    DynamicGenAndAcqWithPerPinDataDelayAndDeskew.c
*
*  Description:
*  This example demonstrates how to configure data position, data delay,
*  and de-skew per-pin.  External connection is required for this
*  example.
*
...
*        to the clock input terminal (default: STROBE).
...
int main(void)
{
   ...
   ViReal64 acquisitionDeskewInSecChannelA = 10e-9;
   ViReal64 acquisitionDelayInClockPeriodsChannelA = 0.2;
   ViConstString acquisitionChannelB = "9";
   ViReal64 acquisitionDeskewInSecChannelB = 2e-9;
   ViReal64 acquisitionDelayInClockPeriodsChannelB = 0.1;
   ...
   ViReal64 generationDeskewInSecChannelA = acquisitionDeskewInSecChannelA;
   ViReal64 generationDelayInClockPeriodsChannelA = acquisitionDelayInClockPeriodsChannelA;
   ViConstString generationChannelB = "1";
   ViReal64 generationDeskewInSecChannelB = acquisitionDeskewInSecChannelB;
   ViReal64 generationDelayInClockPeriodsChannelB = acquisitionDelayInClockPeriodsChannelB;
   ...
   /* Initialize and configure generation session */
   {
       ...
       /* Delay generation channel A:
          You may use data delay, data deskew, or a combination of both.*/
       {
         /* Apply data deskew */
         checkErr(niHSDIO_SetAttributeViReal64 (generationViSession,
            generationChannelA, NIHSDIO_ATTR_DATA_DESKEW, generationDeskewInSecChannelA));

         /* Enable data delay by configuring data position */
         checkErr(niHSDIO_ConfigureDataPosition (generationViSession,
            generationChannelA, NIHSDIO_VAL_DELAY_FROM_SAMPLE_CLOCK_RISING_EDGE));

         /* Apply data delay */
         checkErr(niHSDIO_ConfigureDataPositionDelay (generationViSession,
            generationChannelA, generationDelayInClockPeriodsChannelA));
      }

      /* Delay generation channel B:
         You may use data delay, data deskew, or a combination of both.*/
      {
         /* Apply data deskew */
         checkErr(niHSDIO_SetAttributeViReal64 (generationViSession,
            generationChannelB, NIHSDIO_ATTR_DATA_DESKEW, generationDeskewInSecChannelB));

         /* Enable data delay by configuring data position */
         checkErr(niHSDIO_ConfigureDataPosition (generationViSession,
            generationChannelB, NIHSDIO_VAL_DELAY_FROM_SAMPLE_CLOCK_RISING_EDGE));

         /* Apply data delay */
         checkErr(niHSDIO_ConfigureDataPositionDelay (generationViSession,
            generationChannelB, generationDelayInClockPeriodsChannelB));
      }
   ...
   /* Initialize and configure acquisition session */
   {
      ...
      /* Delay acquisition channel A:
         You may use data delay, data deskew, or a combination of both.*/
      {
         /* Apply data deskew */
         checkErr(niHSDIO_SetAttributeViReal64 (acquisitionViSession,
            acquisitionChannelA, NIHSDIO_ATTR_DATA_DESKEW, acquisitionDeskewInSecChannelA));

         /* Enable data delay by configuring data position */
         checkErr(niHSDIO_ConfigureDataPosition (acquisitionViSession,
            acquisitionChannelA, NIHSDIO_VAL_DELAY_FROM_SAMPLE_CLOCK_RISING_EDGE));

         /* Apply data delay */
         checkErr(niHSDIO_ConfigureDataPositionDelay (acquisitionViSession,
            acquisitionChannelA, acquisitionDelayInClockPeriodsChannelA));
      }

      /* Delay acquisition channel B:
         You may use data delay, data deskew, or a combination of both.*/
      {
         /* Apply data deskew */
         checkErr(niHSDIO_SetAttributeViReal64 (acquisitionViSession,
            acquisitionChannelB, NIHSDIO_ATTR_DATA_DESKEW, acquisitionDeskewInSecChannelB));

         /* Enable data delay by configuring data position */
         checkErr(niHSDIO_ConfigureDataPosition (acquisitionViSession,
            acquisitionChannelB, NIHSDIO_VAL_DELAY_FROM_SAMPLE_CLOCK_RISING_EDGE));

         /* Apply data delay */
         checkErr(niHSDIO_ConfigureDataPositionDelay (acquisitionViSession,
            acquisitionChannelB, acquisitionDelayInClockPeriodsChannelB));
      }
