#
# makefile for the project DynamicGenAndAcqWithPerPinDataDelayAndDeskew
#
# To run this from command prompt type:
#    nmake /f DynamicGenAndAcqWithPerPinDataDelayAndDeskew.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenAndAcqWithPerPinDataDelayAndDeskew
!IF "$(CFG)" == ""
CFG=debug
