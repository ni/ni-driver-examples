#
# makefile for the project DynamicAcqAndGen-SourceSynchronous
#
# To run this from command prompt type:
#    nmake /f DynamicAcqAndGen-SourceSynchronous.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicAcqAndGen-SourceSynchronous
!IF "$(CFG)" == ""
CFG=debug
