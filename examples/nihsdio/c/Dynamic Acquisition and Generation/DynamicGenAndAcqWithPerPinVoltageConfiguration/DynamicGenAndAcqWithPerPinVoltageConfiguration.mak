#
# makefile for the project DynamicGenAndAcqWithPerPinVoltageConfiguration
#
# To run this from command prompt type:
#    nmake /f DynamicGenAndAcqWithPerPinVoltageConfiguration.mak CFG=<debug | release>
#
# defaults to debug build if no configuration is specified.
#
PROJECT=DynamicGenAndAcqWithPerPinVoltageConfiguration
!IF "$(CFG)" == ""
CFG=debug
