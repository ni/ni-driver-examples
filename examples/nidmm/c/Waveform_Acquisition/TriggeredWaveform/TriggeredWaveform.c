...
/* ReadWaveform                                                               */
/*                                                                            */
/* This example performs a waveform acquisition that is started by a          */
/* trigger. Set the waveform acquisition function, range, sample rate         */
/* and number of points in the waveform. The requested samples are returned   */
/* using the Fetch Waveform function.                                         */
/*                                                                            */
/* Functions Utilized:                                                        */
/*                                                                            */
/* niDMM_init                                                                 */
...
int main (int argc, char *argv[])
{
   ...
   /*- Call niDM_ConfiureTrigger to set trigger source -----------------*/
   checkErr(niDMM_ConfigureTrigger (vi, triggerSource, NIDMM_VAL_AUTO_DELAY));

   /*- niDMM_Initiate will start the acquisition -----------------------*/
   checkErr(niDMM_Initiate (vi));

   // At this point, the instrument is armed and ready to receive the
   // trigger
   ...
   /*- call niDMM_FetchWaveform to retrieve the acquired data ----------*/
   checkWarn(niDMM_FetchWaveform (vi, NIDMM_VAL_TIME_LIMIT_AUTO, numOfSamples,
