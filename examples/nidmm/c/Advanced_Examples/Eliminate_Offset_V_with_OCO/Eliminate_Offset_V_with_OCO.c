...
/*                                                                            */
/* Eliminate Offset Voltage Using Offset Compensated Ohms                     */
/*                                                                            */
/* This examples describes how to program a National Instruments Multimeter   */
/* to perform resistance measurements with the Offset Compensated Ohms        */
/* attribute.                                                                 */
/*                                                                            */
/* Functions Utilized:                                                        */
/*                                                                            */
...
int main (int argc, char *argv[])
{
   ...
   ViInt32   measurementType        = NIDMM_VAL_4_WIRE_RES;
   ViReal64  range                  = 1000.00;
   ViReal64  resolution             = 5.5;
   ViReal64  absoluteResolution     = 0.01;
   ViReal64  reading                = 0.0;
   ViInt32   offsetCompOhms         = NIDMM_VAL_OFFSET_COMP_OHMS_ON;
   ...
   checkErr(niDMM_ConfigureOffsetCompOhms (vi, offsetCompOhms));
