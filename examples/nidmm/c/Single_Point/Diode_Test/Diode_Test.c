...
/* to perform a Diode Testing measurement.                                    */
/*                                                                            */
/* Functions Utilized:                                                        */
/*                                                                            */
/* niDMM_init                                                                 */
...
int main (int argc, char *argv[])
{
   ...
   ViChar    instModel[256]   = "PCI-4060";
   ViChar    *aux_queryResp   = "";
   ViInt32   measurementType  = NIDMM_VAL_DIODE;
   ViReal64  powerlineFreq    = NIDMM_VAL_60_HERTZ;
   ViReal64  current          = NIDMM_VAL_1_MICROAMP;
   ViReal64  range            = 2.00;
   ...
   /*- Getting Device ID -----------------------------------------------*/
   checkErr(niDMM_GetAttributeViString (vi, VI_NULL, NIDMM_ATTR_INSTRUMENT_MODEL,256, instModel));

   /*- Configuring Current Source  -------------------------------------*/
   checkErr(niDMM_ConfigureCurrentSource(vi, current));
   ...
   /*- Checking if measurement is Out-of-Range -------------------------*/
   checkErr(niDMM_IsOverRange(vi, reading, &isOverRange));
