...
/*                                                                            */
/* Multi-Functions Measurement                                                */
/*                                                                            */
/* This examples describes how to program a National Instruments Multimeter   */
/* to perform multiple types of measurements.                                 */
/* The user can select on the front panel what type of measurement is         */
/* to be performed.                                                           */
/*                                                                            */
/* Functions Utilized:                                                        */
/*                                                                            */
...
int main (int argc, char *argv[])
{
   ...
   ViReal64  absoluteResolution     = 0.000;
...
Error:
   ...
   else
   {
      ...
      printf("reading = %lf\n", reading);
      printf("absoluteResolution = %lf", absoluteResolution);
   }
