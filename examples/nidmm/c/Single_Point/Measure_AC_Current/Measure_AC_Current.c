...
/* to perform a simple AC current measurement.                                */
/*                                                                            */
/* Functions Utilized:                                                        */
/*                                                                            */
/* niDMM_init                                                                 */
...
int main (int argc, char *argv[])
{
   ...
   ViInt32   measurementType  = NIDMM_VAL_AC_CURRENT;
   ViReal64  minFrequency     = 40.00;
   ViReal64  maxFrequency     = 25000.00;
   ViReal64  range            = 0.200;
   ...
   /*- Configure AC Measurement ----------------------------------------*/
   checkErr(niDMM_ConfigureMeasurementDigits(vi, measurementType, range, resolution));

   /*- Configure AC Measurement Bandwidth ------------------------------*/
   checkErr(niDMM_ConfigureACBandwidth (vi, minFrequency, maxFrequency));
