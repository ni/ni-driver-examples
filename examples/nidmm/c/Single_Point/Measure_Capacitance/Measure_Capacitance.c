...
/* to perform a simple Capacitance measurement.                               */
/*                                                                            */
/* Functions Utilized:                                                        */
/*                                                                            */
/* niDMM_init                                                                 */
...
int main (int argc, char *argv[])
{
    ...
    ViInt32   measurementType       = NIDMM_VAL_CAPACITANCE;
    ViInt32   measurementsToAverage = 1;
    ViReal64  range                 = 100e-6;
   ...
   promptForResourceName(resourceName);
    ...
    checkErr(niDMM_SetAttributeViInt32(vi, "", NIDMM_ATTR_LC_NUMBER_MEAS_TO_AVERAGE,
