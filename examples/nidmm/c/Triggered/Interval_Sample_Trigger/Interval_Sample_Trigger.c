...
/*                                                                            */
/* Acquire Multiple Samples - Interval Sample Trigger                         */
/*                                                                            */
/* This examples describes how to program a National Instruments Multimeter   */
/* to perform a multiple samples acquisition using Interval Sample Trigger.   */
/*                                                                            */
/* Utilized Functions:                                                        */
/*                                                                            */
/* niDMM_init                                                                 */
...
int main (int argc, char *argv[])
{
   ...
   ViInt32   triggerSample       = NIDMM_VAL_INTERVAL;
   ViReal64  sampleTriggerInt    = 0.10;
   ...
   checkErr(niDMM_ConfigureMultiPoint (vi, 1, numOfMeas, triggerSample, sampleTriggerInt));
