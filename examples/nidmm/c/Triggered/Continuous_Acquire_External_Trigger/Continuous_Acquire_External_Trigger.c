...
/* External Trigger and External Sample Trigger                               */
/*                                                                            */
/* This examples describes how to program a National Instruments Multimeter   */
/* to perform a triggered multiple samples acquisition, using both trigger    */
/* and sample trigger.                                                        */
/*                                                                            */
/* Functions Utilized:                                                        */
/*                                                                            */
...
int main (int argc, char *argv[])
{
   ...
   while (!StopMeas)
   {
      ...
      if (ptsAvailable)
      {
         ...
         printf("Received %i points; avg=%3.6f\n",ptsAvailable,(float)average);
