...
namespace NationalInstruments.Examples.PulseVoltage
{
    public partial class MainForm : Form
    {
        ...
        double PulseVoltageLevel
        {
            get
            {
                return decimal.ToDouble(this.pulseVoltageLevelNumeric.Value);
            }
        }
        ...
        double PulseCurrentLimitRange
        {
            get
            {
                return decimal.ToDouble(this.pulseCurrentLimitRangeNumeric.Value);
            }
        }
