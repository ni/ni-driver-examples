...
'      LCR Current Amplitude, LCR Impedance Autorange, LCR Impedance Range, LCR DC Bias Source, 
...
#Region "MainForm configuration values"
    ...
    Private ReadOnly Property ImpedanceAutorange() As Double
        Get
    ...
    Private ReadOnly Property AcCurrent() As Double
        Get
            Return Decimal.ToDouble(Me.lcrCurrentUpDown.Value)
        End Get
    End Property
