...
#End Region
    ...
    Private ReadOnly Property CarrierFreqRmpStart() As Double
        Get
            Return Decimal.ToDouble(Me.carrierFrequencyRampStrtNumeric.Value)
        End Get
    End Property

    Private ReadOnly Property CarrierFreqRmpStop() As Double
        Get
            Return Decimal.ToDouble(Me.carrierFrequencyRampStopNumeric.Value)
        End Get
    End Property
    ...
    Private ReadOnly Property TimerEventInterval() As Double
        Get
            Return Decimal.ToDouble(Me.timerEventIntervalNumeric.Value)
        End Get
    End Property
    ...
    Private Sub FetchIQData()
        ...
        Dim wfmInfo As RfsaWaveformInfo() = New RfsaWaveformInfo(NumberOfSteps - 1) {}
        Dim data As ComplexDouble(,)
        data = rfsaSession.Acquisition.IQ.FetchIQMultiRecordComplex(Of ComplexDouble)(0, NumberOfSteps, NumberOfSamples, timeout, wfmInfo)
    ...
    Private Sub ConfigureListMode()
        Dim propertyList As RfsaConfigurationListProperties() = New RfsaConfigurationListProperties() {RfsaConfigurationListProperties.IQCarrierFrequency, RfsaConfigurationListProperties.ReferenceLevel}
    ...
    Private Sub ChangeControlState(ByVal isEnabled As Boolean)
        ...
        Me.carrierFrequencyRampStrtNumeric.Enabled = isEnabled
        Me.carrierFrequencyRampStopNumeric.Enabled = isEnabled
        Me.referenceLevelRampStrtNumeric.Enabled = isEnabled
        Me.referenceLevelRampStopNumeric.Enabled = isEnabled
        Me.timerEventIntervalNumeric.Enabled = isEnabled
    End Sub
