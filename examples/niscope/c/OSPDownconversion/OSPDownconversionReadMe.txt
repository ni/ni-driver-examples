...
This example shows how to program a downconversion acquisition.  With
an input signal of 10.1 MHz and default configurations you should see
a sine wave of .1 MHz.  As you change the center frequency you should
see the frequency of the sine wave change too.  If you move the input
sine wave outside the bandwidth of the device you should see only ground.

Basically this example illistrates how you can use the DDC to see only
