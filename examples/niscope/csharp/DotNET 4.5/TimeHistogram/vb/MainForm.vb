...
#Region "Mainform configuration values"
    ...
    Private ReadOnly Property ReferencePosition() As Double
        Get
            Return Decimal.ToDouble(Me.triggerReferencePositionNumeric.Value)
        End Get
    End Property

    Private ReadOnly Property HighTimeLimit() As PrecisionTimeSpan
        Get
            Return New PrecisionTimeSpan(Decimal.ToDouble(Me.highTimeLimitNumeric.Value))
        End Get
    End Property
    ...
    Private ReadOnly Property LowTimeLimit() As PrecisionTimeSpan
        Get
            Return New PrecisionTimeSpan(Decimal.ToDouble(Me.lowTimeLimitNumeric.Value))
        End Get
    End Property
    ...
    Private ReadOnly Property Measurement1() As ScopeScalarMeasurementType
        Get
            Return CType(Me.measurement1ComboBox.SelectedItem, ScopeScalarMeasurementType)
        End Get
    End Property

    Private ReadOnly Property Measurement2() As ScopeScalarMeasurementType
        Get
            Return CType(Me.measurement2ComboBox.SelectedItem, ScopeScalarMeasurementType)
        End Get
    End Property
    ...
    Private WriteOnly Property ScalarResult() As Double
        Set(value As Double)
            Me.scalarResult2TextBox.Text = value.ToString()
        End Set
    End Property

    Private WriteOnly Property StatScalarResult() As Double
        Set(value As Double)
...
#End Region
    ...
    Private Sub StartAcquisition()
        ...
        Dim timeHistogram As AnalogWaveformCollection(Of Double) = Nothing
        ...
        Try
            ...
            While Not [stop]
                ...
                ' Configure the attributes used in the time histogram calculation.
                ...
                Dim statistics As ScopeScalarMeasurementStatistics = scopeSession.Channels(ChannelName).Measurement.FetchScalarMeasurementStatistics(Timeout, Measurement1)(0)
                StatScalarResult = statistics.MeasurementResult
    ...
    Private Shared Sub SetupDataGridView(dgv As DataGridView, numberOfWaveforms As Integer)
        ...
        For columnIndex As Integer = 0 To numberOfWaveforms - 1
