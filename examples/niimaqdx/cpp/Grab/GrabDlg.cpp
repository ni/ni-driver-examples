...
//
//  Description:
//      Constructs the main CGrabDlg.
//
//////////////////////////////////////////////////////////////////////////////
CGrabDlg::CGrabDlg(CWnd* pParent) :
    CDialog(CGrabDlg::IDD, pParent),
    session(0),
    image(NULL),
    grabThread(NULL),
    stopThread(false)
{
	//{{AFX_DATA_INIT(CGrabDlg)
	camName = _T("cam0");
...
//////////////////////////////////////////////////////////////////////////////
//
//  CGrabDlg::DoDataExchange
//
//  Description:
//      Exchanges data between our member variables and the dialog.
//
//////////////////////////////////////////////////////////////////////////////
void CGrabDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CGrabDlg)
...
//  Message map
//============================================================================
BEGIN_MESSAGE_MAP(CGrabDlg, CDialog)
...
void CGrabDlg::OnGrab() 
{
    ...
    try 
	{
        ...
        if (status)
            throw status;
        stopThread = false;
        grabThread = AfxBeginThread (CGrabDlg::GrabThreadFunc, this);
...
//
//////////////////////////////////////////////////////////////////////////////
UINT CGrabDlg::GrabThreadFunc (LPVOID param) 
{
     return reinterpret_cast<CGrabDlg*>(param)->GrabThreadFuncInternal ();
}

UINT CGrabDlg::GrabThreadFuncInternal ()
{
	//------------------------------------------------------------------------
...
//////////////////////////////////////////////////////////////////////////////
//
//  CGrabDlg::OnUpdateDialog
//
//  Description:
//      Message handler used to update the dialog with the latest data.
//
//////////////////////////////////////////////////////////////////////////////
LRESULT CGrabDlg::OnUpdateDialog(WPARAM, LPARAM) {
    UpdateData(FALSE);
    return 0;
}
...
//
//////////////////////////////////////////////////////////////////////////////
void CGrabDlg::DisplayNIIMAQdxError(IMAQdxError error) {
    //--------------------------------------------------------------------
...
//
//////////////////////////////////////////////////////////////////////////////
void CGrabDlg::DisplayNIVisionError(int error) {
    //--------------------------------------------------------------------
