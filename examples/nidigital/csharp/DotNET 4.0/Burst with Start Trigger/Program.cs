namespace NationalInstruments.Examples.NIDigital.BurstWithStartTrigger
{
    ...
    /// and burst a pattern from a digital pattern instrument.
    /// </summary>
    /// <remarks>
    /// Using this example:
                ...
                using (NIDigital session = new NIDigital(ResourceName, true, true, OptionString))
                {
                    ...
                    switch (TriggerTypeSetting)
                    {
                        ...
                        case TriggerType.DigitalEdge:
                            session.Trigger.StartTrigger.DigitalEdge.Configure(TriggerSource, DigitalEdge.Rising);
                            session.PatternControl.BurstPattern(string.Empty, PatternStartLabel, true, true, Timeout);
                            break;
                        ...
                        case TriggerType.Software:
                            session.Trigger.StartTrigger.Software.Configure();
                            ...
                            session.Trigger.StartTrigger.Software.Send();
