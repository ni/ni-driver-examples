        ...
        void StartGeneration()
        {
            ...
            try
            {
                ...
                for (numberOfStepsIterator = 0; numberOfStepsIterator < numberOfSteps; numberOfStepsIterator++)
                {
                    ...
                    // Configuration List Step index. Once the Active Configuration List Step is set, the
                    // Frequency or Power Level will be modified for this Configuration List Step in the Configuration 
