C/C++ CLEARTRIGGER Sample Application

This directory contains the following:

     README.TXT             -  This readme file
     CLEARTRIGGER.C         -  Windows C sample application


Description
-----------

The ClearTrigger sample application was written to acquire
measurements from a Fluke 45 Digital Multimeter. The application is a
Windows console application. It illustrates how to use the NI-488.2 API.
A Windows console application is a Windows application which uses text-
based input and output, not a graphical interface.  This allows you to
quickly create a Windows application by using simple input and output 
...
the sample application, ClearTrigger.c. The "NIEXTCCOMPILERSUPP"
...
language support files.
  ...
  typing in using the 32-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" ClearTrigger.c "%NIEXTCCOMPILERSUPP%\lib32\msvc\ni4882.obj" /MD
  ...
  typing in using the 64-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" ClearTrigger.c "%NIEXTCCOMPILERSUPP%\lib64\msvc\ni4882.obj" /MD
