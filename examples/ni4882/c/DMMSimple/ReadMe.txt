...
a Fluke 45 Digital Multimeter. The application is a Windows console
application. It illustrates how to use the NI-488.2 API. A Windows
console application is a Windows application which uses text-based input
and output, not a graphical interface.  This allows you to quickly
create a Windows application by using simple input and output functions
