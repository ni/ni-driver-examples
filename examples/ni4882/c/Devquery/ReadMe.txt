C/C++ DEVQUERY Sample Application

This directory contains the following:

     README.TXT            -  This readme file
     DEVQUERY.C            -  Windows C Device-level sample application
...
the sample application, Devquery.c. The "NIEXTCCOMPILERSUPP"
...
language support files.
  ...
  typing in using the 64-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" Devquery.c "%NIEXTCCOMPILERSUPP%\lib64\msvc\ni4882.obj" /MD
