C/C++ BDQUERY Sample Application

This directory contains the following:

     README.TXT            -  This readme file
     BDQUERY.C             -  Windows C Board-level sample application
...
the sample application, Bdquery.c. The "NIEXTCCOMPILERSUPP"
...
language support files.
  ...
  typing in using the 32-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" Bdquery.c "%NIEXTCCOMPILERSUPP%\lib32\msvc\ni4882.obj" /MD
  ...
  typing in using the 64-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" Bdquery.c "%NIEXTCCOMPILERSUPP%\lib64\msvc\ni4882.obj" /MD
