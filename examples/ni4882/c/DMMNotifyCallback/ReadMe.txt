C/C++ NotifyCallback Sample Application

This directory contains the following:

     README.TXT            -  This readme file
     NotifyCallback.C      -  Windows C NI-488.2 sample application
...
the sample application, NotifyCallback.c. The "NIEXTCCOMPILERSUPP"
...
language support files.
  ...
  typing in using the 32-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" NotifyCallback.c "%NIEXTCCOMPILERSUPP%\lib32\msvc\ni4882.obj" /MD
  ...
  typing in using the 64-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" NotifyCallback.c "%NIEXTCCOMPILERSUPP%\lib64\msvc\ni4882.obj" /MD
