C/C++ SERIALPOLL Sample Application

This directory contains the following:

     README.TXT             -  This readme file
     SERIALPOLL.C           -  Windows C sample application


Description
-----------

The SerialPoll sample application was written to acquire
...
the sample application, SerialPoll.c. The "NIEXTCCOMPILERSUPP"
...
language support files.
  ...
  typing in using the 32-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" SerialPoll.c "%NIEXTCCOMPILERSUPP%\lib32\msvc\ni4882.obj" /MD
  ...
  typing in using the 64-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" SerialPoll.c "%NIEXTCCOMPILERSUPP%\lib64\msvc\ni4882.obj" /MD
