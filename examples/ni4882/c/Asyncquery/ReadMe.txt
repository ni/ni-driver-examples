C/C++ ASYNCQUERY Sample Application

This directory contains the following:

     README.TXT            -  This readme file
     ASYNCQUERY.C          -  Windows C Asynchronous sample application
...
the sample application, Asyncquery.c. The "NIEXTCCOMPILERSUPP"
...
language support files.
  ...
  typing in using the 32-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" Asyncquery.c "%NIEXTCCOMPILERSUPP%\lib32\msvc\ni4882.obj" /MD
  ...
  typing in using the 64-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" Asyncquery.c "%NIEXTCCOMPILERSUPP%\lib64\msvc\ni4882.obj" /MD
