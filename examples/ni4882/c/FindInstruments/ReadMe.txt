C/C++ FINDINSTRUMENTS Sample Application

This directory contains the following:

     README.TXT            -  This readme file
     FINDINSTRUMENTS.C     -  Windows C 488.2 sample application
                              to find instruments on the GPIB bus
...
the sample application, FindInstruments.c. The "NIEXTCCOMPILERSUPP"
...
language support files.
  ...
  typing in using the 64-bit environment:
    ...
    Build the application to use DLL-specific version of C Runtime Library:
      cl /I"%NIEXTCCOMPILERSUPP%\include" FindInstruments.c "%NIEXTCCOMPILERSUPP%\lib64\msvc\ni4882.obj" /MD
