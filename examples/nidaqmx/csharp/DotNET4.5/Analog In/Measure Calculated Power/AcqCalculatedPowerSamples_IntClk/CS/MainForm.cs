...
*
* Example program:
*   AcqCalculatedPowerSamples_IntClk
*
* Category:
*   AI
*
* Description:
*   This example demonstrates how to acquire a finite amount of calculated power data using an
*   internal clock.
*
...
namespace NationalInstruments.Examples.AcqCalculatedPowerSamples_IntClk
{
    ...
    {        
        ...
        private void InitializeComponent()
        {
            ...
            this.voltageMinimumValueNumeric.Value = new decimal(new int[] {
            0,
            0,
            0,
            -2147418112});
            ...
            this.startButton.Location = new System.Drawing.Point(364, 340);
            ...
            this.Text = "Acquire Calculated Power Samples - Internal Clock";
